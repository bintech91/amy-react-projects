            ...
            <div>
                <div className="container row">
                    <div className="col s12 m12 l4">
                        <div className="card project">
                            <div className="card-content">
                                <h3 style={{ marginTop: "50px", fontWeight: "bold", color: "rgb(127, 81, 233)" }}>
                                    <AnimatedNumber value={this.state.value1} formatValue={this.formatValue} /></h3>
                                <div>
                    ...
                    <div className="col s12 m12 l4">
                        <div className="card project" >
                            <div className="card-content ">
                                <h3 style={{ marginTop: "50px", fontWeight: "bold", color: "#456DFE" }}>
                                    <AnimatedNumber value={this.state.value2} formatValue={this.formatValue} /></h3>
                                <div>
                    ...
                    <div className="col s12 m12 l4">
                        <div className="card project">
                            <div className="card-content">
                                <h3 style={{ marginTop: "50px", fontWeight: "bold", color: "#2962ff" }}>
                                    <AnimatedNumber value={this.state.value3} formatValue={this.formatValue} />+</h3>
                                <div>
